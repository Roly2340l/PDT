...
def pose_disgusto(motion_service):
    names  = ["RElbowRoll", "RElbowYaw", "RShoulderPitch", "RShoulderRoll", "RWristYaw","LElbowRoll", "LElbowYaw", "LShoulderPitch", "LShoulderRoll", "LWristYaw","HipPitch","HeadYaw","LHand","RHand"] #Uso de articulaciones
    angles = [ rad(51.3), rad(35.1), rad(14.8), rad(-10), rad(12), rad(-19.3), rad(-91.6), rad(21.9), rad(11.1), rad(1.9), rad(16.5), rad(-47.3),1,1] #Definicion de los valores de las articulaciones
