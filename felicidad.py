...
def pose_felicidad(motion_service):
    ...
    angles = [ rad(0.5), rad(90), rad(-74.2), rad(-1.1), rad(90.5), rad(-0.5), rad(-90), rad(-74.0), rad(0.6), rad(-90.5),0,0]#Definicion de los valores de las articulaciones
